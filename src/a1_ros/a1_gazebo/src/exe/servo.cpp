...
#include "a1_msgs/MotorCmd.h"
#include "a1_msgs/MotorState.h"
...
public:
    multiThread(){
        ...
        servo_sub[0] = nm.subscribe("/a1_gazebo/FR_hip_controller/state", 1, &multiThread::FRhipCallback, this);
        servo_sub[1] = nm.subscribe("/a1_gazebo/FR_thigh_controller/state", 1, &multiThread::FRthighCallback, this);
        servo_sub[2] = nm.subscribe("/a1_gazebo/FR_calf_controller/state", 1, &multiThread::FRcalfCallback, this);
        servo_sub[3] = nm.subscribe("/a1_gazebo/FL_hip_controller/state", 1, &multiThread::FLhipCallback, this);
        servo_sub[4] = nm.subscribe("/a1_gazebo/FL_thigh_controller/state", 1, &multiThread::FLthighCallback, this);
        servo_sub[5] = nm.subscribe("/a1_gazebo/FL_calf_controller/state", 1, &multiThread::FLcalfCallback, this);
        servo_sub[6] = nm.subscribe("/a1_gazebo/RR_hip_controller/state", 1, &multiThread::RRhipCallback, this);
        servo_sub[7] = nm.subscribe("/a1_gazebo/RR_thigh_controller/state", 1, &multiThread::RRthighCallback, this);
        servo_sub[8] = nm.subscribe("/a1_gazebo/RR_calf_controller/state", 1, &multiThread::RRcalfCallback, this);
        servo_sub[9] = nm.subscribe("/a1_gazebo/RL_hip_controller/state", 1, &multiThread::RLhipCallback, this);
        servo_sub[10] = nm.subscribe("/a1_gazebo/RL_thigh_controller/state", 1, &multiThread::RLthighCallback, this);
        servo_sub[11] = nm.subscribe("/a1_gazebo/RL_calf_controller/state", 1, &multiThread::RLcalfCallback, this);
    }
    ...
    void FRhipCallback(const a1_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void FRthighCallback(const a1_msgs::MotorState& msg)
    {
    ...
    void FRcalfCallback(const a1_msgs::MotorState& msg)
    {
    ...
    void FLhipCallback(const a1_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void FLthighCallback(const a1_msgs::MotorState& msg)
    {
    ...
    void FLcalfCallback(const a1_msgs::MotorState& msg)
    {
    ...
    void RRhipCallback(const a1_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void RRthighCallback(const a1_msgs::MotorState& msg)
    {
    ...
    void RRcalfCallback(const a1_msgs::MotorState& msg)
    {
    ...
    void RLhipCallback(const a1_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void RLthighCallback(const a1_msgs::MotorState& msg)
    {
    ...
    void RLcalfCallback(const a1_msgs::MotorState& msg)
    {
...
{
    ros::init(argc, argv, "a1_gazebo_servo");
    ...
    lowState_pub = n.advertise<a1_msgs::LowState>("/a1_gazebo/lowState/state", 1);
    servo_pub[0] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/FR_hip_controller/command", 1);
    servo_pub[1] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/FR_thigh_controller/command", 1);
    servo_pub[2] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/FR_calf_controller/command", 1);
    servo_pub[3] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/FL_hip_controller/command", 1);
    servo_pub[4] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/FL_thigh_controller/command", 1);
    servo_pub[5] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/FL_calf_controller/command", 1);
    servo_pub[6] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/RR_hip_controller/command", 1);
    servo_pub[7] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/RR_thigh_controller/command", 1);
    servo_pub[8] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/RR_calf_controller/command", 1);
    servo_pub[9] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/RL_hip_controller/command", 1);
    servo_pub[10] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/RL_thigh_controller/command", 1);
    servo_pub[11] = n.advertise<a1_msgs::MotorCmd>("/a1_gazebo/RL_calf_controller/command", 1);
