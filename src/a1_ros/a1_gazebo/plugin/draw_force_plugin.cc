...
namespace gazebo
{
    class A1DrawForcePlugin : public VisualPlugin
    {
        public:
        A1DrawForcePlugin():line(NULL){}
        ~A1DrawForcePlugin(){
        ...
        void Load(rendering::VisualPtr _parent, sdf::ElementPtr _sdf )
        {
            ...
            this->force_sub = this->rosnode->subscribe(this->topic_name+"/"+"the_force", 30, &A1DrawForcePlugin::GetForceCallback, this);
            this->update_connection = event::Events::ConnectPreRender(boost::bind(&A1DrawForcePlugin::OnUpdate, this));
    ...
    GZ_REGISTER_VISUAL_PLUGIN(A1DrawForcePlugin)
}
