...
namespace gazebo
{
    class A1FootContactPlugin : public SensorPlugin
    {
        public:
        A1FootContactPlugin() : SensorPlugin(){}
        ~A1FootContactPlugin(){}
        ...
        void Load(sensors::SensorPtr _sensor, sdf::ElementPtr _sdf)
        {
            ...
            if (!this->parentSensor){
                gzerr << "A1FootContactPlugin requires a ContactSensor.\n";
                return;
            }
            ...
            this->update_connection = this->parentSensor->ConnectUpdated(std::bind(&A1FootContactPlugin::OnUpdate, this));
    ...
    GZ_REGISTER_SENSOR_PLUGIN(A1FootContactPlugin)
}
